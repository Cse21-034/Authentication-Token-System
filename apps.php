            ...
            <div class="col-lg-12">
                <div class="card bg-dark">
                    <div class="card-header bg-dark">
                        <h2><i class="fas fa-tachometer-alt"></i>Company Apps</h2>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="card h-100 bg-dark border-secondary">
                                        <div class="card-body">
                                            <h5 class="card-title"><i class="fas fa-search"></i>My Profile</h5>
                                            <p class="card-text">View you profile information</p>
                                            <a href="../api/user_profile.php" class="btn btn-outline-light">View My Profile</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card h-100 bg-dark border-secondary">
                                        <div class="card-body">
                                            <h5 class="card-title"><i class="fas fa-sync-alt"></i>File</h5>
                                            <p class="card-text">Access system confidential guide here</p>
                                           <a href="../api/download.php" class="btn btn-outline-warning">Download Protected Files</a>
